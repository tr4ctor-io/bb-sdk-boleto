...
class BoletosApi
{
     ...
     *
     * @param  \Swagger\Client\ModelBoletoBB\RequisicaoAlterarBoleto $body Representação dos campos de requisição de uma solicitação de alteração dos dados de boletos bancários. (required)
     ...
     * @return \Swagger\Client\ModelBoletoBB\RespostaAlterarBoleto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\ModelBoletoBB\RespostaAlterarBoleto, HTTP status code, HTTP response headers (array of strings)
     */
    public function alteraBoletoBancarioIdWithHttpInfo($body, $authorization, $gw_dev_app_key, $id)
    {
        $returnType = '\Swagger\Client\ModelBoletoBB\RespostaAlterarBoleto';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\ModelBoletoBB\RespostaAlterarBoleto',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\ModelBoletoBB\Erro',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\ModelBoletoBB\ErroOAuthNaoAutorizado',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\ModelBoletoBB\RespostaBoletosBaixaOperacional
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\ModelBoletoBB\RespostaBoletosBaixaOperacional, HTTP status code, HTTP response headers (array of strings)
     */
    public function boletosBaixaOperacionalWithHttpInfo($gw_dev_app_key, $authorization, $agencia, $conta, $carteira, $variacao, $data_inicio_agendamento_titulo, $data_fim_agendamento_titulo, $estado_baixa_operacional = null, $modalidade_titulo = null, $data_inicio_vencimento_titulo = null, $data_fim_vencimento_titulo = null, $data_inicio_registro_titulo = null, $data_fim_registro_titulo = null, $horario_inicio_agendamento_titulo = null, $horario_fim_agendamento_titulo = null, $id_proximo_titulo = null)
    {
        $returnType = '\Swagger\Client\ModelBoletoBB\RespostaBoletosBaixaOperacional';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\ModelBoletoBB\RespostaBoletosBaixaOperacional',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\ModelBoletoBB\ErroV4',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Swagger\Client\ModelBoletoBB\IdCancelarpixBody $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\ModelBoletoBB\InlineResponse200
     */
     ...
     * @param  string $gw_dev_app_key É a chave de acesso do aplicativo do desenvolvedor utilizada em produção, obtida no Portal do Desenvolvedor. Essa chave será usada para identificação do aplicativo.Para os testes em ambiente de homologação, trocar por gw-app-key. Ex: 0021239456d80136bebf005056891bed. CAMPO OBRIGATÓRIO. (required)
     * @param  string $id Número de identificação do boleto (correspondente ao NOSSO NÚMERO, numeroTituloCliente), no formato STRING, com 20 dígitos, que deverá ser formatado da seguinte forma: “000” + (número do convênio com 7 dígitos) + (10 algarismos - se necessário, completar com zeros à esquerda). Campo Obrigatório. (required)
     * @param  \Swagger\Client\ModelBoletoBB\IdCancelarpixBody $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\ModelBoletoBB\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelarPixBoletoIdWithHttpInfo($authorization, $gw_dev_app_key, $id, $body = null)
    {
        $returnType = '\Swagger\Client\ModelBoletoBB\InlineResponse200';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\ModelBoletoBB\InlineResponse200',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\ModelBoletoBB\RespostaConsultaPixBoleto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\ModelBoletoBB\RespostaConsultaPixBoleto, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultarPixBoletoIdWithHttpInfo($id, $gw_dev_app_key, $authorization, $numero_convenio)
    {
        $returnType = '\Swagger\Client\ModelBoletoBB\RespostaConsultaPixBoleto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\ModelBoletoBB\RespostaConsultaPixBoleto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\ModelBoletoBB\RespostaDetalhamentoBoleto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\ModelBoletoBB\RespostaDetalhamentoBoleto, HTTP status code, HTTP response headers (array of strings)
     */
    public function detalhaBoletoBancarioIdWithHttpInfo($id, $gw_dev_app_key, $authorization, $numero_convenio)
    {
        $returnType = '\Swagger\Client\ModelBoletoBB\RespostaDetalhamentoBoleto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\ModelBoletoBB\RespostaDetalhamentoBoleto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $gw_dev_app_key É a chave de acesso do aplicativo do desenvolvedor utilizada em produção, obtida no Portal do Desenvolvedor. Essa chave será usada para identificação do aplicativo.Para os testes em ambiente de homologação, trocar por gw-app-key. Ex: 0021239456d80136bebf005056891bed. CAMPO OBRIGATÓRIO. (required)
     * @param  string $id Número de identificação do boleto (correspondente ao NOSSO NÚMERO, numeroTituloCliente), no formato STRING, com 20 dígitos, que deverá ser formatado da seguinte forma: “000” + (número do convênio com 7 dígitos) + (10 algarismos - se necessário, completar com zeros à esquerda). Campo Obrigatório. (required)
     * @param  \Swagger\Client\ModelBoletoBB\IdGerarpixBody $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\ModelBoletoBB\InlineResponse200
     ...
     * @param  string $gw_dev_app_key É a chave de acesso do aplicativo do desenvolvedor utilizada em produção, obtida no Portal do Desenvolvedor. Essa chave será usada para identificação do aplicativo.Para os testes em ambiente de homologação, trocar por gw-app-key. Ex: 0021239456d80136bebf005056891bed. CAMPO OBRIGATÓRIO. (required)
     * @param  string $id Número de identificação do boleto (correspondente ao NOSSO NÚMERO, numeroTituloCliente), no formato STRING, com 20 dígitos, que deverá ser formatado da seguinte forma: “000” + (número do convênio com 7 dígitos) + (10 algarismos - se necessário, completar com zeros à esquerda). Campo Obrigatório. (required)
     * @param  \Swagger\Client\ModelBoletoBB\IdGerarpixBody $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\ModelBoletoBB\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \Swagger\Client\ModelBoletoBB\RequisicaoRegistroBoletos $body body (required)
     * @param  string $authorization É um \&quot;token\&quot; de acesso fornecido pelo OAuth 2.0. Ex: Bearer [ACCESS_TOKEN] (required)
     * @param  string $gw_dev_app_key É a chave de acesso do aplicativo do desenvolvedor utilizada em produção, obtida no Portal do Desenvolvedor. Essa chave será usada para identificação do aplicativo.  Para os testes em ambiente de homologação, trocar por gw-app-key.  Ex: 0021239456d80136bebf005056891bed. CAMPO OBRIGATÓRIO. (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\ModelBoletoBB\RespostaRegistroBoletos
     */
     ...
     * Registra Boleto de Cobrança
     *
     * @param  \Swagger\Client\ModelBoletoBB\RequisicaoRegistroBoletos $body (required)
     * @param  string $authorization É um \&quot;token\&quot; de acesso fornecido pelo OAuth 2.0. Ex: Bearer [ACCESS_TOKEN] (required)
     * @param  string $gw_dev_app_key É a chave de acesso do aplicativo do desenvolvedor utilizada em produção, obtida no Portal do Desenvolvedor. Essa chave será usada para identificação do aplicativo.  Para os testes em ambiente de homologação, trocar por gw-app-key.  Ex: 0021239456d80136bebf005056891bed. CAMPO OBRIGATÓRIO. (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\ModelBoletoBB\RespostaRegistroBoletos, HTTP status code, HTTP response headers (array of strings)
     */
    public function incluiBoletoBancarioIdWithHttpInfo($body, $authorization, $gw_dev_app_key)
    {
        $returnType = '\Swagger\Client\ModelBoletoBB\RespostaRegistroBoletos';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\ModelBoletoBB\RespostaRegistroBoletos',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\ModelBoletoBB\RespostaListaBoletos[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\ModelBoletoBB\RespostaListaBoletos[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listaBoletosIdWithHttpInfo($gw_dev_app_key, $authorization, $indicador_situacao, $agencia_beneficiario, $conta_beneficiario, $conta_caucao = null, $carteira_convenio = null, $variacao_carteira_convenio = null, $modalidade_cobranca = null, $cnpj_pagador = null, $digito_cnpj_pagador = null, $cpf_pagador = null, $digito_cpf_pagador = null, $data_inicio_vencimento = null, $data_fim_vencimento = null, $data_inicio_registro = null, $data_fim_registro = null, $data_inicio_movimento = null, $data_fim_movimento = null, $codigo_estado_titulo_cobranca = null, $boleto_vencido = null, $indice = null)
    {
        $returnType = '\Swagger\Client\ModelBoletoBB\RespostaListaBoletos[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\ModelBoletoBB\RespostaListaBoletos[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\ModelBoletoBB\ErroV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Swagger\Client\ModelBoletoBB\RequisicaoBaixaBoleto $body body (required)
     * @param  string $authorization É um \&quot;token\&quot; de acesso fornecido pelo OAuth 2.0. Ex: Bearer [ACCESS_TOKEN] (required)
     * @param  string $gw_dev_app_key É a chave de acesso do aplicativo do desenvolvedor utilizada em produção, obtida no Portal do Desenvolvedor. Essa chave será usada para identificação do aplicativo.  Para os testes em ambiente de homologação, trocar por gw-app-key.  Ex: 0021239456d80136bebf005056891bed. CAMPO OBRIGATÓRIO. (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\ModelBoletoBB\RespostaBaixaBoleto
     */
     ...
     * Permitir a baixa/cancelamento de um  título de cobrança.
     *
     * @param  \Swagger\Client\ModelBoletoBB\RequisicaoBaixaBoleto $body (required)
     * @param  string $authorization É um \&quot;token\&quot; de acesso fornecido pelo OAuth 2.0. Ex: Bearer [ACCESS_TOKEN] (required)
     * @param  string $gw_dev_app_key É a chave de acesso do aplicativo do desenvolvedor utilizada em produção, obtida no Portal do Desenvolvedor. Essa chave será usada para identificação do aplicativo.  Para os testes em ambiente de homologação, trocar por gw-app-key.  Ex: 0021239456d80136bebf005056891bed. CAMPO OBRIGATÓRIO. (required)
     * @param  string $id Número do boleto bancário (único e exclusivo) que identifica o título e é usado para pagá-lo. (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\ModelBoletoBB\RespostaBaixaBoleto, HTTP status code, HTTP response headers (array of strings)
     */
    public function permitirBaixaCancelamentoIdWithHttpInfo($body, $authorization, $gw_dev_app_key, $id)
    {
        $returnType = '\Swagger\Client\ModelBoletoBB\RespostaBaixaBoleto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\ModelBoletoBB\RespostaBaixaBoleto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
